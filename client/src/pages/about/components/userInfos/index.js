                ...
                <div className={Style['user-infos']}>
...

                    {
                        ...
                        <p className="operate">
                            ...
                            <span className="modify" onClick={this.goEditAccounts}>Edit Account</span>
                    ...
                    <p className="attention-status">
                        <span><b>{this.props.personalInfo.topicCounts}</b>Post</span>
                        <span><b>{this.props.personalInfo.fansCounts}</b>Fan</span>
                        <span><b>Following</b>{this.props.personalInfo.followCounts}</span>
                    </p>
