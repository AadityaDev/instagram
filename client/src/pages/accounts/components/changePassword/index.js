        ...
        this.props.form.validateFieldsAndScroll(async (err, values) => {
            if (!err) {
                ...
                if (newPassword !== confirmPassword ) {
                    notification['error']({
                        message: 'New password is inconsistent with confirmation password'
                    })
                    return
                }
            ...
            <section className={Style['edit-accounts']}>
                ...
                <Form onSubmit={this.handleSubmit}>
                    <FormItem
                        {...formItemLayout}
                        label={(
                            <span className="form-item-label">Old Password</span>
                        )}
                        >
                    ...
                    {...formItemLayout}
                        label={(
                            <span className="form-item-label">new password</span>
                        )}
                    >
                    ...
                    {...formItemLayout}    
                        label={(
                            <span className="form-item-label">Determine new password</span>
                        )}
                    >
