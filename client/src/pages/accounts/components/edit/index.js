            ...
            <section className={Style['edit-accounts']}>
                <Row className="header">
                    ...
                    <Col span={16}  className="user_abstract">
                        ...
                        <div className={'notice'}>Change avatar<Upload successCb={this.changeAvatarCb} className={'notice'} /></div>
                ...
                <Form onSubmit={this.handleSubmit}>
                    ...
                    {...formItemLayout}
                        label={(
                            <span className="form-item-label">website</span>
                        )}
                    >
                    ...
                    <FormItem
                        {...formItemLayout}
                            label={(
                                <span className="form-item-label">Personal profile</span>
                            )}
                        >
                    ...
                    {...formItemLayout}
                        label={(
                            <span className="form-item-label">mailbox</span>
                        )}
                    >
                    ...
                    {...formItemLayout}
                        label={(
                            <span className="form-item-label">Gender</span>
                        )}
                    >
